...
public class PurchaseControllerTest extends BookstorePurchasesApplicationTests {
    ...
    void setUp() {
       ...
       this.purchaseController = new PurchaseController(getAllPurchaseService, getPurchaseService, savePurchaseService
    ...
    void saveWhenClientDontExist() throws Exception {
        ...
        when(clientRepository.getClient(UUID.fromString("12d51c0a-a843-46fc-8447-5fda559ec69b")))
                .thenThrow(new EntityNotFoundException((
                        UUID.fromString("12d51c0a-a843-46fc-8447-5fda559ec69b")), "Client"));
    ...
    void getAllTest() throws Exception {
        mockMvc.perform(get(url))
                ...
                .andExpect(jsonPath("$[0].clientUuid", is("12d51c0a-a843-46fc-8447-5fda559ec69b")))
                ...
                .andExpect(jsonPath("$[1].clientUuid", is("df670f4b-5d4d-4f70-ae78-f2ddc9fa1f14")))
    ...
    void updateWhenBookDontExist() throws Exception {
        ...
        when(bookRepository.getBook(UUID.fromString("df670f4b-5d4d-4f70-ae78-f2ddc9fa1f14")))
                .thenReturn(BookBuilder.book2L());
        when(bookRepository.getBook(UUID.fromString("27eaa649-e8fa-4889-bd5a-ea6825b71e61")))
                .thenThrow(new EntityNotFoundException(UUID.fromString
                        ("27eaa649-e8fa-4889-bd5a-ea6825b71e61"),"Book"));


        purchase.setBooksUuid(ids);
        String json = mapper.writeValueAsString(purchase);
