...
public class GetAllPurchaseServiceImplTest {
    ...
    void findAllTest() {
        ...
        assertThat(purchases.get(0).getClientUuid().toString(), is("12d51c0a-a843-46fc-8447-5fda559ec69b"));
        assertThat(purchases.get(0).getBooksUuid().size(), is(3));
        ...
        assertThat(purchases.get(1).getClientUuid().toString(), is("df670f4b-5d4d-4f70-ae78-f2ddc9fa1f14"));
        assertThat(purchases.get(1).getBooksUuid().size(), is(3));
